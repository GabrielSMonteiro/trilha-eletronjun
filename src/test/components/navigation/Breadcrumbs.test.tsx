...
describe('Breadcrumbs', () => {
  ...
  it('renderiza span para item intermediário sem href', () => {
    const items = [
      { label: 'Sem link' },
    ...
    expect(screen.getByText('Sem link').tagName).toBe('SPAN');
    expect(screen.getByText('Sem link')).not.toHaveAttribute('aria-current', 'page');
  });
});
