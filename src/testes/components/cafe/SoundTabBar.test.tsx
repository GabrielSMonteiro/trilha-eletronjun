...
describe('SoundTabBar', () => {
  ...
  it('aciona o onTogglePlay ao clicar no botão de play', async () => {
    ...
    // Na aba Cafeteria, o som 'ambiente' tem isPlaying: false → exibe botão Play
    const ambienteHeader = await screen.findByText('Ambiente');
    // Sobe até o container do item e acha o botão
  ...
  it('aciona onVolumeChange ao usar o slider', async () => {
    ...
    // Radix UI Slider responde a ArrowRight/ArrowLeft
    slider.focus();
    await user.keyboard('{ArrowRight}');

    // O valor atual de 'ambiente' no mock é 0.5 (50).
    // Ao pressionar ArrowRight, deve ir para 51 → 0.51
