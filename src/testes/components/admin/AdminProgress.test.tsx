...
// Mock ResizeObserver for Recharts if needed, though Recharts is not explicitly imported here
...
describe('AdminProgress Component', () => {
  ...
  it('renders progress data', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('cat1')).toBeInTheDocument(); // Category name used in progress card
    });
  });
