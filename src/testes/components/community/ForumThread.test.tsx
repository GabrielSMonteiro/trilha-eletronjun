...
describe('ForumThread', () => {
  ...
  it('permite criar um novo post', async () => {
    ...
    // The component refetches after submit
  });
  ...
  it('curte um post', async () => {
    ...
    // Encontrar o botão de curtir (tem ícone ThumbsUp)
    // Buscamos pelo container ou pelo elemento mais próximo
    const likeBtn = screen.getAllByRole('button')[1]; // 0 é Voltar, 1 é curtir do post 1 (assumindo que o Enviar Post é depois)
